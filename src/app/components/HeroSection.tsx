...
export default function HeroSection() {
  ...
  return (
    <div className='flex items-center justify-center bg-conic-gradient bg-full h-screen'>
      ...
      <div><Image alt='girl in gym clothes' width={'500'} height={'600'} src={heroImage1} loader={uploadcareLoader}/></div>
      <div><Image alt='girl in gym clothes' width={'500'} height={'600'} src={heroImage2} loader={uploadcareLoader}/></div>
